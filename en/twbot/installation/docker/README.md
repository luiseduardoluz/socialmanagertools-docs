...
## 2. Run
1. Get [config.js](https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-twbot/master/config.js.tpl) remove  `.tpl ` suffix and save file in your home directory, fill it properly.
...
```sh
docker run --restart=always --name=socialmanagertools-twbot -d -v /home/pi/config.js:/app/configs/config.js socialmanagertools/socialmanagertools-twbot:armv7
```
...
```sh
docker run --restart=always --name=socialmanagertools-twbot -d -v /home/[USERNAME]/config.js:/app/configs/config.js social-manager-tools/socialmanagertools-twbot:amd64
```
